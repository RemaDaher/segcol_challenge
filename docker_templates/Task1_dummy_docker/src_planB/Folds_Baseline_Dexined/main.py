...
def test(checkpoint_path, dataloader, model, device, output_dir, args):
    ...
    with torch.no_grad():
        ...
        for batch_id, sample_batched in enumerate(dataloader):
            ...
            f_out, a_out = save_image_batch_to_disk(preds,
                                     output_dir,
                                     file_names,
                                     image_shape,
                                     arg=args)
...
def main(args):
    ...
    if args.is_testing:
        ...
        if args.double_img:
            ...
            fuse_list, average_list = test(checkpoint_path, dataloader_val, model, device, output_dir, args)
